        ...
        <div class="container">
            ...
            <div class="card border-secondary">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Саженцы из школки, выкопка в конце октября – начале ноября. Сроки могут сдвинуться в зависимости от вызревания саженцев. </p>
                    <p class="card-text">При формировании заказов с августа по ноябрь мы не можем гарантировать наличие всех саженцев в заказе, все зависит от их вызревания.</p>
                    <p class="card-text">Реализация саженцев осуществляется с момента выкопки, продолжается до конца мая либо пока саженцы есть в наличии.</p>
